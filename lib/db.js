...
// const sumSpans = async ({taskName, taskId}) => {
//   spanDb.aggregate(    
//     [{ $match: , { 
//             author: "dave" 
//           }}] 
...
// );
// }
// spanDb.aggregate( [ { $project: { item: 1, total: { $subtract: [ { $add: [ "$price", "$fee" ] }, "$discount" ] } } } ] )


module.exports = {
  findOrCreateTask, /*insertTask,*/ insertSpan, updateSpan, /*loadAllTasks,*/ loadTasks, findTask
}
